...
public class ErasureCodes {
    ...
    public static int matrixDecode(int k, int m, int w, int[] matrix, int row_k_ones, int[] erasures,
                                   byte[][] data_ptrs,
    ...
    public static int makeDecodingMatrix(int k, int m, int w, int[] matrix, int[] erased, int[] decoding_matrix,
                                         int[] dm_ids) {
        int[] tmpmat;
        int j = 0;
    ...
    public static void matrixEncode(int k, int m, int w, int[] matrix, byte[][] data_ptrs, byte[][] coding_ptrs,
                                    int size) {
        if (w != 8 && w != 16 && w != 32) {
