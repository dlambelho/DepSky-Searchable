...
//			System.out.println("ERROR_PROCESSING_METADATA: " + metadataReply);
    ...
    public void checkDataIntegrity(CloudReply valuedataReply) {
        try {
            ...
            if (valuehash.equals(
                    valuedataReply.vHash)) { //comparing hash of data value with the hash presented in metadata file
    ...
    public void writeNewMetadata(CloudReply reply) {
        ...
        try {
            ...
            DepSkyMetadata newMD =
                    new DepSkyMetadata(mprops, getSignature(mprops.getBytes()), reply.allDataHash, valueDataFileId);
