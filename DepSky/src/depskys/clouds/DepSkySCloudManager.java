        ...
        try {
            ...
            switch (request.op) {
                ...
                case DEL_CONT:
                    ...
                    boolean delContRes = driver.deleteContainer(request.reg.getBucketName(), request.namesToDelete,
                            request.accessToOtherAccount);
                ...
                case GET_DATA:
                    ...
                    byte[] data =
                            driver.downloadData(request.reg.getBucketName(), request.did, request.accessToOtherAccount);
                    //				if(driver.getDriverId().equals("cloud1"))
                    r = new CloudReply(request.op, request.seqNumber,
                            ...
                            request.accessToOtherAccount, request.numVersionToKeep);
                    r.setInitReceiveTime(init);
                    r.setStartTime(request.startTime);
                ...
                case LIST_DU:
                    ...
                    r = new CloudReply(request.op, request.seqNumber,
                            ...
                            request.reg, request.protoOp, request.isMetadataFile,
                            request.w_data, request.vNumber, request.allDataHash, buckets, null,
                            request.accessToOtherAccount);
                ...
                case LIST:
                    ...
                    break;
                case SET_ACL:
                    String[] credentialsToShare =
                            driver.setAcl(request.reg.getBucketName(), request.canonicalId, request.permission);
